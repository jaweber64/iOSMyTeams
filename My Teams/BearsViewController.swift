...
//  My Teams
//
//  Created by Janet Weber on 2/28/16.
...
class BearsViewController: UIViewController {
    ...
    private var playerInfo: [String]!                      // array of player info (one for each key - first name, nflID)
    private let URLstart = "http://www.chicagobears.com/team/roster/" // nfl player stat url start
    private let slash = "/"                                // slash
    private let schedURL = "http://prod.static.bears.clubs.nfl.com/assets/docs/2015_cb_schedule_00086_3.375x2.125in_2pnl_web.pdf"
    ...
    override func viewDidLoad() {
        ...
        let plistURL = bundle.URLForResource("bearsPlayers", withExtension: "plist")
    ...
    */
    ...
    @IBAction func onButtonPressed(sender: AnyObject) {
        ...
        if (sender.tag == 31) {     // player stat button is sender
            ...
            let nflID = playerInfo![1]                       // get info from playerInfo array to construct
            let nflIDname = playerInfo![2]                   // url
            let statURL = URLstart + nflIDname + slash + nflID
            //print("\(statURL)")
            urlstr = statURL
