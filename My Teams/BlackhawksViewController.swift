//
//  BlackhawksViewController.swift
//  My Teams
//
...
class BlackhawksViewController: UIViewController,
    ...
    private var playerInfo: [String]!                      // array of player info (one for each key - first name, nhlID)
    private let URLstart = "http://blackhawks.nhl.com/club/player.htm?id=" // nhl player stat url start
    private let slash = "/"                                // slash
    private let schedURL = "http://blackhawks.nhl.com/v2/ext/Fliers/2015-16_season_schedule_flyer.pdf"
    ...
    override func viewDidLoad() {
        ...
        let plistURL = bundle.URLForResource("blackhawksPlayers", withExtension: "plist")
    ...
    */
    ...
    @IBAction func onButtonPressed(sender: AnyObject) {
        ...
        if (sender.tag == 21) {     // player stat button is sender
            ...
            let nhlID = playerInfo![1]                       // get info from playerInfo array to construct
            //let mlbIDname = playerInfo![2]                   //    url
            let statURL = URLstart + nhlID
            urlstr = statURL
